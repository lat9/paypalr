...
$define = [
    ...
    'MODULE_PAYMENT_PAYPALR_CHOOSE_PAYPAL' => 'Click below to pay with PayPal Wallet:',
    'MODULE_PAYMENT_PALPALR_CHOOSE_CARD' => 'Click below to pay with PayPal Credit Card:',
